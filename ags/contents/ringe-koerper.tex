...
\begin{itemize}
	\item Isomorphismus: $\varphi^{-1}$ Ringhomomorphismus
	\item $\im\varphi \le S$
	\item $\varphi$ Monomorphismus $\iff \Ker\varphi = \{0\}$
\end{itemize}

\subsection*{Ideal}
$R$ kommutativer Ring mit Eins und $\emptyset \neq I \subseteq R$.
\begin{itemize}
	\item $a+b \in I$
	\item $r \cdot a \in I$ ($r\in R, a \in I$)
\end{itemize}

\subsection*{Faktorringe}
$I \trianglelefteq R$ Ideal, dann $R/I$ Ring.
